...
const initApp = () => {
    ...
    itemEntryForm.addEventListener("submit", (event) => {
        event.preventDefault(); // prevent default behavior of the form (refreshing the page)
        processSubmission();
    });
    ...
    clearItems.addEventListener("click", (event) => {
        ...
        if(list.length) {
            const confirmed = confirm("Are you sure you want to clear the whole list?");
            if(confirmed) {
                toDoList.clearList();
...
// deletes all child elements of parent element
